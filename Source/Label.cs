...
namespace Compatibility
{
    ...
    #endif
  {
    ...
    {
      //note: don't call base.ApplyStyle() at descendant
      ...
      if ((Content == null) && DesignerProperties.IsInDesignTool) Text = "Label";
      #endif
    }
    ...
    public static readonly DependencyProperty ContentProperty =
        DependencyProperty.Register("Content", typeof(object), typeof(Compatibility.Label),
    ...
    {
      Compatibility.Label target = (Compatibility.Label)d;
    ...
    {
      Text = ((newContent == null) && DesignerProperties.IsInDesignTool)? "Label" : (string)newContent;
    }
